...
//const char* websockets_server_host = "ws://10.8.0.106"; //Enter server adress
...
//    Serial.print(" ");
    if(pData[0]==129 && pData[1]>=1){
      Serial.print("Your SPO2 Percentage :");
...
void setup() {
    ...
    bool connected = client.connect("wss://dev02.cognitivehealthintl.com:80/arduino");
    if(connected) {
